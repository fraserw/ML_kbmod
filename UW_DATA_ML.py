...
classes_half = keras_filter.filter_stamps(stamps, conf_thresholds*0.5, class_w_triplets=True)
with open('source_classes.txt', 'w+') as han:
    for i in range(len(ids)):
        print(ids[i], classes[i], classes_half[i], file=han)
